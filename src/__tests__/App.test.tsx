...
describe('App', () => {
  ...
  it('renders MainPage component inside ErrorBoundary', () => {
    render(<App />);
    expect(screen.getByTestId('main-page')).toBeInTheDocument();
    expect(screen.getByText('MainPage Content')).toBeInTheDocument();
  });
  ...
  it('displays ErrorBoundary fallback when MainPage throws an error', async () => {
    ...
    const throwButton = screen.getByTestId('throw-mainpage-error-button');
