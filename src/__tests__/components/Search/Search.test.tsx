...
describe('Search Component Tests', () => {
  ...
  it('does not trigger onSearch callback if search term is empty on button click', () => {
    render(<Search {...defaultProps} />);
    const searchInput = screen.getByPlaceholderText(
      /search for pokemons.../i
    ) as HTMLInputElement;
  ...
  it('does not trigger onSearch callback if search term is only whitespace on button click', () => {
    render(<Search {...defaultProps} />);
    const searchInput = screen.getByPlaceholderText(
      /search for pokemons.../i
    ) as HTMLInputElement;
  ...
  it('does not trigger onSearch if search term is empty on Enter key press', () => {
    render(<Search {...defaultProps} />);
    const searchInput = screen.getByPlaceholderText(
      /search for pokemons.../i
    ) as HTMLInputElement;
  ...
  it('does not trigger onSearch callback if search term is only whitespace on Enter key press', () => {
    render(<Search {...defaultProps} />);
    const searchInput = screen.getByPlaceholderText(
      /search for pokemons.../i
    ) as HTMLInputElement;
